...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('VoiceOverride', function() {
      beforeEach(function() {
        instance = new RavenApi.VoiceOverride();
      });

      it('should create an instance of VoiceOverride', function() {
        // TODO: update the code to test VoiceOverride
        expect(instance).to.be.a(RavenApi.VoiceOverride);
      });
