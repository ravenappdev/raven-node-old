...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SmsOverride', function() {
      beforeEach(function() {
        instance = new RavenApi.SmsOverride();
      });

      it('should create an instance of SmsOverride', function() {
        // TODO: update the code to test SmsOverride
        expect(instance).to.be.a(RavenApi.SmsOverride);
      });
